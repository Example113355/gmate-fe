...
export const getHistoryBook = async (playerId: string) => {
  try {
    ...
    const response = await axios.get(
      `${apiUrl}/players/${playerId}/completebooks`
    );
...
export const getTopClient = async (playerId: string) => {
  try {
    ...
    const processTopClient = async (list: any) => {
...
export const getBookingListById = async (playerId: string) => {
  try {
    ...
    const bookingList = response.data.filter(
      (booking: any) => booking.user !== null
    );
...
export const updateBookingStatus = async (
  ...
  try {
    const response = await axios.put(`${apiUrl}/players/${playerId}/bookings`, {
      id: bookingId,
      status: status,
    });
    return response.data;
